...
const totalCapacity = computed(() =>
  props.silos.reduce((sum, s) => sum + s.capacity, 0)
);

const totalStock = computed(() =>
  props.silos.reduce((sum, s) => sum + s.quantity, 0)
);

const hotspotCount = computed(() =>
  props.silos.filter((s) => s.tempMax > 34).length
);
    ...
    <div class="header-left">
      <div class="brand">
        ...
        <div class="brand-titles">
          <h1 class="app-title">3D Digital Twin</h1>
