...
export const THERMOMETRY_CONFIG = {
	...
	// Cabos de Aço
	CABLE: {
		COLOR_RGB: [0.55, 0.6, 0.68] as [number, number, number],
	},
} as const;
...
export const MATERIAL_CONFIG = {
	SHELL: {
		OPACITY_DEFAULT: 1.0,
		OPACITY_FOCUSED: 0.1, // Apenas a casca do silo selecionado fica translúcida
	...
	BASE: {
		DIFFUSE_RGB: [0.48, 0.5, 0.55] as [number, number, number],
	...
	GRAIN: {
		...
		EMISSIVE_RGB: [0.22, 0.18, 0.1] as [number, number, number],
...
export const ENVIRONMENT_CONFIG = {
	GROUND: {
		WIDTH: 200,
		HEIGHT: 170,
		DIFFUSE_RGB: [0.14, 0.16, 0.2] as [number, number, number],
